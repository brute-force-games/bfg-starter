...
const GameP2pDetailsRoute = () => {
      ...
      <Container style={{ padding: '24px' }}>
        <Stack spacing={3}>
          ...
          <Typography variant="body1" color="secondary">
            Loading P2P details for observer...
          </Typography>
        </Stack>
      </Container>
    )
  ...
  const activeTabId: GameTabId = '/games/watch/$gameId/p2p-details';
...
export const Route = createFileRoute('/games/watch/$gameId/p2p-details')({
  // params: {
