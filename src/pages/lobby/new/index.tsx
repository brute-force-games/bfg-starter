...
// import { CreateGameLobbyParameters, CreateGameLobbyParametersSchema } from '~/types/core/game-lobby';



// export const CreateNewLobbyPage = () => {

//   // const [redirectToLobbyPath, _setRedirectToLobbyPath] = useState<BfgPlayerId | null>(null);
...
//   const defaultFormValues: CreateGameLobbyParameters = {
...
//   const { control, handleSubmit, formState: { errors } } = useForm<CreateGameLobbyParameters>({
//     resolver: zodResolver(CreateGameLobbyParametersSchema),
